...
if (mypin === pinanswer.pin) {
    ...
    if (operationans.operation === "withdraw") {
        ...
        if (mybalance >= amountans.amount) {
            ...
            console.log(chalk.magentaBright(`Unable To Get Transaction Your Balance Is Insufficient`));
        }
    }
        ...
        if (depositans.deposit) {
            ...
            console.log(chalk.italic.greenBright(`Successfully Your Amount Has Been Deposited ${mybalance}`));
        }
    }
        ...
        if (mybalance >= fastcashans.fastcash) {
            ...
            console.log(chalk.cyanBright `Unable To Get Transaction Your Balance Is Insufficient`);
        }
    }
}
else {
